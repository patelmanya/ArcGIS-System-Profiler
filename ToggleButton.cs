        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            else if (this.ToggleStyle == ToggleButtonStyle.Android)
            {
                ...
                else
                {
                    ...
                    if (this.Name.ToString() == "toggleButtonPortsChecks")
                    {
                        globalVariables.globalForm.btn_PortChecks.Visible = true;
                        globalVariables.portsTaskIncluded = true;
                    }
                    else if (this.Name.ToString() == "toggleButtonHealthChecks")
                    {
                        globalVariables.globalForm.btn_HealthChecks.Visible = true;
                        globalVariables.HealthChecksTaskIncluded = true;
                    }
                    else if (this.Name.ToString() == "toggleButtonValidateDS")
                    {
                        globalVariables.globalForm.btnDataStoreValidate.Visible = true;
                        globalVariables.DataStoreValidateTaskIncluded = true;
                    }
                    else if (this.Name.ToString() == "toggleButtonPublishService")
                    {
                        globalVariables.globalForm.btn_Publish.Visible = true;
                        globalVariables.PublishTaskIncluded = true;
                    }
                    else if (this.Name.ToString() == "toggleButtonAGSServReport")
                    {
                        globalVariables.globalForm.btn_Services.Visible = true;
                        globalVariables.ServicesTaskIncluded = true;
                    }
                }
            }
